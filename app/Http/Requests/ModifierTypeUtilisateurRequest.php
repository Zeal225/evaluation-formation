...
class ModifierTypeUtilisateurRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "libelle_type_utilisateur" => "required|string|max:255|unique:type_utlisateurs,libelle_type_utilisateur," . decrypt($this->id)
        ];
    }
