...
class InsererCabinetRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "nom_cabinet" => "required|string|unique:cabinets,nom_cabinet|min:3|max:255",
    ...
    public function messages()
    {
        return [
            ...
            "nom_cabinet.unique" => "Ce nom de cabinet existe déjà",
