...
class InsererFormateurRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            "email_formateur" => "required|email|unique:formateurs",
    ...
    public function messages()
    {
        return [
            ...
            "email_formateur.unique" => "L'email du formateur doit être unique",
