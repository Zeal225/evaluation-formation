...
class InsererCategorieRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "libelle_categorie_appreciation" => "required|min:3|max:255|unique:categorie_appreciations,libelle_categorie_appreciation"
        ];
    }
