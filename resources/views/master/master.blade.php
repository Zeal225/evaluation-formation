...
<script>
    $(function () {
        ...
        $(".delete-objectif").on("click", function (event) {
            event.preventDefault();
            var link = $(this).attr("href");
            Swal.fire({
                title: "Attention !",
                text: "Etes-vous sûr de vouloir supprimer cet objectif ?",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(".delete-categorie").on("click", function (event) {
            event.preventDefault();
            var link = $(this).attr("href");
            Swal.fire({
                title: "Attention !",
                text: "Etes-vous sûr de vouloir supprimer cette catégorie d'appréciatiion ?",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(".delete-appreciation").on("click", function (event) {
            event.preventDefault();
            var link = $(this).attr("href");
            Swal.fire({
                title: "Attention !",
                text: "Etes-vous sûr de vouloir supprimer cette appréciatiion ?",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
        ...
        $(".delete-role").on("click", function (event) {
            ...
            Swal.fire({
                title: "Attention !",
                text: "Etes-vous sûr de vouloir supprimer cet rôle ?",
                icon: "warning",
                showCancelButton: !0,
                confirmButtonClass: "btn btn-primary w-xs me-2 mt-2",
                cancelButtonClass: "btn btn-danger w-xs mt-2",
