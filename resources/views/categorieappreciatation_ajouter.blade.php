                ...
                <div class="card-body">
                    <form action="{{ route("ajouter_categorie") }}" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input value="{{ old("libelle_categorie_appreciation") }}" type="text" name="libelle_categorie_appreciation" class="form-control" id="libelle_categorie_appreciation" placeholder="Entrez le libellé">
