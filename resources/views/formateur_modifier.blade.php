        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">modifier un formateur</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route("modifier_formateur") }}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{ encrypt($formateur->id) }}">
                        <div class="row mb-3">
                            <div class="col-lg-3">
                                <label for="nom_formateur" class="form-label">Nom du formateur</label>
                            </div>
                            <div class="col-lg-9">
                                <input value="{{ old("nom_formateur") ?? $formateur->nom_formateur }}" type="text" name="nom_formateur" class="form-control" id="nom_formateur" placeholder="Entrez le nom du formateur">
                                @error('nom_formateur')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input value="{{ old("prenom_formateur") ?? $formateur->prenom_formateur }}" name="prenom_formateur" type="text" class="form-control" id="prenom_formateur" placeholder="Entrez le prénom du formateur">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input value="{{ old("email_formateur") ?? $formateur->email_formateur }}" name="email_formateur" type="text" class="form-control" id="prenom_formateur" placeholder="Entrez l'email du formateur">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input value="{{ old("tel_formateur") ?? $formateur->tel_formateur }}" name="tel_formateur" type="text" class="form-control" id="tel_formateur" placeholder="Entrez le contact du formateur">
                                @error('tel_formateur')
                                <span class="text-danger">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input value="{{ old("specialite_formateur") ?? $formateur->specialite_formateur }}" name="specialite_formateur" type="text" class="form-control" id="specialite_formateur" placeholder="Entrez la spécialité du formateur">
