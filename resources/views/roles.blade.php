                                    ...
                                    <div id="customerList">
                                        <div class="row g-4 mb-3">
                                            <div class="col-sm-auto">
                                                <div>
                                                    <a href="{{ route("formulaire_ajouter_role") }}" class="btn btn-primary btn-lg">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="{{ route("formulaire_modifier_role", ["id"=>$role->id]) }}" class="btn btn-soft-primary btn-sm"><i class="ri-pencil-line"></i></a>
                                                            </div>
                                                            <div class="remove">
                                                                <a href="{{ route("supprimer_role", ["id"=>encrypt($role->id)]) }}" class="btn btn-soft-danger btn-sm delete-role" id="sa-basic"><i class="ri-delete-bin-2-line"></i></a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
